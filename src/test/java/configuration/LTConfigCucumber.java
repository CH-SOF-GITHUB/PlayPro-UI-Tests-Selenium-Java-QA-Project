...
public class LTConfigCucumber {
    ...
    public static final String LT_USERNAME_CUCUMBER = "chakerlt1";
    public static final String LT_ACCESSKEY_CUCUMBER = "LT_CbXl7y5tdDqGXPrCFWXXcWBzIuJVPrjEeVvZvOmdFTGBs69";
