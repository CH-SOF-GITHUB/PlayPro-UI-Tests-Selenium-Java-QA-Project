...
public class RegisterTests4 extends BaseClass {
    ...
    @Test(priority = 1, description = "TC_RF_005", suiteName = "(TS_001) - Register Functionality")
    public void registerWithYesNewsLetterOption() {
        ...
        registerPage.enterEmail("chaker66@yopmail.com");
        // Enter The Telephone
        ...
        checkTrue = newsletterPage.isNewsLetterYESChecked("true");
